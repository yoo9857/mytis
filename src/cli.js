...
function parseArgs(argv) {
  ...
  for (let i = 0; i < argv.length; i++) {
    ...
    // 발행 간격을 무시하고 즉시 발행 (틀린그림찾기가 뜰 수 있다 — pace.js 참고)
 ...
 * 틀린그림찾기·2단계 인증이 뜨면 열린 브라우저에서 직접 통과시켜야 한다.
 */
