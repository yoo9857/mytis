...
export const DEFAULT_ALIASES = {
  ...
  /* eco-m(경제 블로그) 의 실제 카테고리 셋. 이름에 가운뎃점이 있어 **점을 뺀 형태도**
   * 함께 걸어 둔다 ('스타·연예인' / '스타연예인' 과 같은 이유).
   * ⚠️ '부동산' 은 '청약'·'대출' 을 재태크와 나눠 갖는다. 청약은 부동산 제도이므로
   * 부동산 쪽에 더 강한 낱말('청약통장'·'전월세'·'등기')을 둬서 갈리게 했다. */
  '재테크 · 생활경제': [
    '재테크', '연말정산', '세액공제', '소득공제', '적금', '예금', '파킹통장', '저축',
    '연금저축', 'irp', '절세', '보험', '실비', '생활비', '지원금', '바우처', '소비',
  ],
  '재테크생활경제': [
    '재테크', '연말정산', '세액공제', '소득공제', '적금', '예금', '파킹통장', '저축',
    '연금저축', 'irp', '절세', '보험', '실비', '생활비', '지원금', '바우처', '소비',
  ...
  '주식 · 투자': [
    '주식', 'etf', '증시', '코스피', '코스닥', '배당', '배당소득', '증권', '나스닥',
    '연금계좌', 'isa', '펀드', '채권', '수수료', '괴리율', '분배금',
  ],
  '주식투자': [
    '주식', 'etf', '증시', '코스피', '코스닥', '배당', '배당소득', '증권', '나스닥',
    '연금계좌', 'isa', '펀드', '채권', '수수료', '괴리율', '분배금',
  ...
  부동산: [
    '부동산', '청약', '청약통장', '전월세', '전세', '월세', '임대차', '보증금',
    '주택담보대출', '주담대', 'ltv', 'dsr', '등기', '취득세', '재건축', '분양',
  ],
